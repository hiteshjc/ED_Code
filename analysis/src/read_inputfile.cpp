...
{	
	...
	read_Parameter(filein, sev1, ev1);
	read_Parameter(filein, sev2, ev2);
}
...
void read_pevfamily(	string &filein,
			string &filepEV1)
{	
	string spEV1("pEVfamily_file=");
	read_file_string(filein, spEV1, filepEV1);
}
void read_pev1(	string &filein,
			string &filepEV1)
{	
...
{	
	string spEV1("pEV1_file=");
	string spEV2("pEV2_file=");
	string spEV3("pEV3_file=");

	read_file_string(filein, spEV1, filepEV1);
	read_file_string(filein, spEV2, filepEV2);
	read_file_string(filein, spEV3, filepEV3);
}
...
{	
	...
	string spEV2("pEV2_file=");
	string spEV3("pEV3_file=");
	string spEV4("pEV4_file=");

	read_file_string(filein, spEV1, filepEV1);
	read_file_string(filein, spEV2, filepEV2);
	read_file_string(filein, spEV3, filepEV3);
	read_file_string(filein, spEV4, filepEV4);
}
