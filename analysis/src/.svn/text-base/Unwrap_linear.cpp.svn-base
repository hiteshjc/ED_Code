...
int main(int argc, char *argv[])
{
	...
	string filein, filepEV, filepEV1, filepEV2, fileout;
...
// Reads vectors 1 and 2 unwraps
	...
	v_coeff1.clear(); p_block_states1.clear1(); Norm1.clear();
	...
	v_coeff2.clear(); p_block_states2.clear1(); Norm2.clear();

// Forms linear combination and outputs
	vector<ids> psi(psi1.size() );
	for(int64_t jb = 0; jb < psi1.size(); j++)
	{
		psi[jb].coeff = alpha*psi1[jb].coeff + beta*psi2[jb].coeff;
