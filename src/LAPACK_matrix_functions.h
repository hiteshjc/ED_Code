...
// ZX in the vector to be rescaled
extern "C" void zscal_( const int *n,
			complex< double > *za,
			complex< double > *ZX,
			const int *incx);

inline void zscal(	const int n,
			complex< double > za,
			complex< double > *ZX,
			const int incx)
{
...
extern "C" complex< double > zdotc_(	const int *n,
...
inline complex< double > zdotc(	const int n,
				const complex< double > *ZX,
				const int incx,
				const complex< double > *ZY,
				const int incy)
